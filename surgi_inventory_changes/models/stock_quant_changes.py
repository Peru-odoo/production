...
class stock_quant_inherit_wizard(models.Model):
    ...
    location_selling = fields.Many2one(related='location_id.location_selling' ,string='Selling Location',store=True)
    location_id_asset = fields.Many2one(related='location_id.location_asset' ,string='Asset Location',store=True)